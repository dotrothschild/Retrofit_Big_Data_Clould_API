...
android {
    ...
    buildTypes {
        debug {
            ...
            // Accessing property from gradle.properties
            buildConfigField("String", "BDC_API_KEY", "\"${project.findProperty("BDC_API_KEY")}\"")
        }
        release {
...
dependencies {
    ...
    implementation(project(":ReverseGeocodingBdc"))
}